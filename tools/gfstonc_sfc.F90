...
subroutine read_nemsio_header_sfc(filename,nlons,nlats,nrecs,idate,nfhour)
...
end subroutine read_nemsio_header_sfc
...
subroutine read_nemsio_varnames(filename, nrecs, irecnames, ireclevtypes)
   ...
   do nrec=1,nrecs
    ...
    !  print *,nrec,recnames(nrec),reclevtypes(nrec)
   enddo
   call nemsio_close(gfile, iret=iret)
