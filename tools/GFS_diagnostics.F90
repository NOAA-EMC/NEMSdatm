module GFS_diagnostics
  ...
  type GFS_externaldiag_type
    ...
    !for setting 'required for data atmosphere'
    logical              :: req4datm
...
!                                        Grid, Tbd, Cldprop, Radtend, IntDiag, Init_parm)
  subroutine GFS_externaldiag_populate(ExtDiag,idxtotal)
  !subroutine GFS_externaldiag_populate(idxtotal)
!---------------------------------------------------------------------------------------------!
!   DIAGNOSTIC_METADATA                                                                       !
